...
// const oneOlder = people.some(function (person) {
...
const commentWithFind = comments.find(comment => comment.id === 823423);
console.log(commentWithFind);
